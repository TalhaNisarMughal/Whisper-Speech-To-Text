...
async def transcribe_audio(file: UploadFile = File(...)):
    ...
    if file.content_type not in ["audio/wav", "audio/mpeg", "audio/mp4", "audio/mp4a", "audio/mp3", "audio/flac"]:
        raise HTTPException(status_code=400, detail="Unsupported file format. Supported file formats are wav, mp3, flac, mp4, and mp4a")
